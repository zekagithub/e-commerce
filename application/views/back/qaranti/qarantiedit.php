...
<?php $this->load->view('back/include/leftmenu'); ?>
 ...
 <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Qaranti muqavilesini deyisdir</h3>
            </div>
        
            <form class="form-horizontal" action="<?php echo base_url('admin/qarantiupdate');?>" method="post"">
              <div class="box-body">
              ...
              <div class="box-footer">
                <a class="btn btn-warning" href="<?php echo base_url('admin/qaranti');?>">Legv et</a>
