...
<meta property="og:url"           content="<?php echo base_url('xususigunlerabout/');echo $melumat->sef?>" />
...
<?php $this->load->view('front/eynek/about/breadcrumb');?>
<?php $this->load->view('front/eynek/about/main_content');?>
</div>
</div>
</div>
</div>
