...
<h3>Cox satilan mehsullar</h3></div>
...
<a href="<?php echo base_url('eynekabout/');echo $melumat->sef;?>"><img alt="<?php $melumat->title?>" title="<?php $melumat->title?>" class="img-responsive" src="<?php echo base_url(); echo $melumat->tmb1 ?>"/></a>
</div>
</div>
...
<?php echo $melumat->description?></div>
</div>
</div>
</div>
</div>
...
<div class="image">
<a href="<?php echo base_url('eynekabout/');echo $melumat->sef;?>"><img src="<?php echo base_url();echo $melumat->tmb1?>" alt="<?php echo $melumat->title;?> ?>" title="<?php echo $melumat->title;?> ?>" class="img-responsive"/></a>
</div>
<div class="caption">
<div class="price"><span class="price-new"><?php echo $melumat->price?></span> Man</div>
<div class="name">
<a href="<?php echo base_url('eynekabout/');echo $melumat->sef;?>"><?php echo $melumat->title?></a>
</div>
...
<div class="left col-sm-4">
<div class="quickview_image image">
<a href="<?php echo base_url('elektronikabout/');echo $melumat->sef;?>"><img alt="<?php $melumat->title;?>" title="<?php $melumat->title;?>" class="img-responsive" src="<?php echo base_url(); echo $melumat->tmb1 ?>"/></a>
</div>
</div>
<div class="right col-sm-8">
<h2><?php echo $melumat->title?></h2>
...
<div class="sale">Bax</div>
<div class="image">
<a href="<?php echo base_url('elektronikabout/');echo $melumat->sef;?>"><img src="<?php echo base_url(); echo $melumat->tmb1;?>" alt="<?php echo $melumat->title; ?>" title="<?php echo $melumat->title; ?>" class="img-responsive"/></a>
</div>
<div class="caption">
<div class="price"><span class="price-new"><?php echo $melumat->price?></span> Man</div>
<div class="name">
...
<div class="price"><span class="price-new"><?php echo $melumat->price?></span> Man</div>
<div class="name">
<a href="<?php echo base_url('saatabout/');echo $melumat->sef;?>">Ü<?php echo $melumat->title;?></a>
</div>
<div class="description">
<?php echo $melumat->description;?></div>
</div>
...
<div class="left col-sm-4">
<div class="quickview_image image">
<a href="<?php echo base_url('specialabout/');echo $melumat->sef;?>"><img alt="<?php echo $melumat->title; ?>" title="<?php echo $melumat->title; ?>" class="img-responsive" src="<?php echo base_url(); echo $melumat->tmb1 ?>"/></a>
</div>
</div>
<div class="right col-sm-8">
<h2><?php echo $melumat->title?></h2>
