...
<h1 class="product-title baslik" value="#"><?php echo $melumat->title; ?></h1>
...
<span class="price-new fiyat" value="#"><?php echo $melumat->price;?> Man</span>
...
<button type="button" id="button-cart" productid="#" value="#" class="btn btn-add addToCart">Sepete Elave et</button>

<a href="#" class="btn btn-primary" id="button-cart">Satın Almak için Giriş Yap</a>
